...
export function SidebarMenuAction({ className, asChild = false, showOnHover = false, ...props }) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 after:absolute after:-inset-2 md:after:hidden group-data-[collapsible=icon]:hidden",
...
export function SidebarMenuSub({ className, ...props }) {
  return (
    <ul
      ...
      className={cn("flex w-full flex-col gap-1 overflow-hidden pl-4 text-sm [&>li:last-child]:mb-1", className)}
      {...props}
    />
  );
}
...
export function SidebarMenuSubItem({ className, ...props }) {
  return <li data-slot="sidebar-menu-sub-item" data-sidebar="menu-sub-item" className={cn("relative", className)} {...props} />;
}

// Sidebar Menu Sub Button
export function SidebarMenuSubButton({ className, ...props }) {
  return <button data-slot="sidebar-menu-sub-button" data-sidebar="menu-sub-button" className={cn("flex w-full items-center gap-2 rounded-md p-2 text-sm outline-hidden ring-sidebar-ring transition-all hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2", className)} {...props} />;
}
